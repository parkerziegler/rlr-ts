...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_history_PathUtils__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_query_string__ = __webpack_require__(11);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__reducer__ = __webpack_require__(81);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__middleware__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__enhancer__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__util_create_installer__ = __webpack_require__(84);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_normalize_href__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__util_flatten_routes__ = __webpack_require__(32);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var decodeComponent = __webpack_require__(75);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_query_string__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__environment_browser_router__ = __webpack_require__(77);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__environment_hash_router__ = __webpack_require__(88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__environment_express_router__ = __webpack_require__(90);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__environment_hapi_router__ = __webpack_require__(91);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_link__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_fragment__ = __webpack_require__(122);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_assign__ = __webpack_require__(76);
...
(function(root, factory) {
  if (('function' === "function") && (__webpack_require__(86) != null)) {
...
var _setStatic = __webpack_require__(124);
...
var _getDisplayName = __webpack_require__(125);
...
var react_dom_1 = __webpack_require__(59);
...
initialState, redux_1.compose(enhancer, redux_1.applyMiddleware(middleware), window.devToolsExtension ? window.devToolsExtension() : function (f) { return f; }));
/* Invert comments for immutable */
var initialLocation = store.getState().router;
// const initialLocation = store.getState().get('router').toJS();
if (initialLocation) {
    store.dispatch(redux_little_router_1.initializeCurrentLocation(initialLocation));
}
react_dom_1.render(wrap_1.default(store)(demo_1.default), document.getElementById('content'));
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(3), __webpack_require__(69)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_normalize_href__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__install__ = __webpack_require__(7);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var createBrowserRouter = function createBrowserRouter(installer) {
  return function (_ref) {
    ...
    var pathname = fullPathname.indexOf(basename) === 0 ? fullPathname.slice(basename.length) : fullPathname;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__types__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_merge_queries__ = __webpack_require__(15);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__util_match_cache__ = __webpack_require__(34);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util_create_matcher__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_validate_routes__ = __webpack_require__(87);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__util_flatten_routes__ = __webpack_require__(32);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_url_pattern__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__throw_error__ = __webpack_require__(36);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_history_createHashHistory__ = __webpack_require__(89);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_history_createMemoryHistory__ = __webpack_require__(37);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__util_merge_queries__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__util_normalize_href__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__util_stringify_href__ = __webpack_require__(121);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mapStateToProps__ = __webpack_require__(117);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mergeProps__ = __webpack_require__(118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__selectorFactory__ = __webpack_require__(119);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__combineReducers__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__bindActionCreators__ = __webpack_require__(115);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__applyMiddleware__ = __webpack_require__(116);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(3), __webpack_require__(44)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__verifySubselectors__ = __webpack_require__(120);
function _objectWithoutProperties(obj, keys) { var target = {}; for (var i in obj) { if (keys.indexOf(i) >= 0) continue; if (!Object.prototype.hasOwnProperty.call(obj, i)) continue; target[i] = obj[i]; } return target; }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_recompose_getContext__ = __webpack_require__(123);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_recompose_withContext__ = __webpack_require__(126);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_recompose_compose__ = __webpack_require__(127);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_url_pattern__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__util_match_cache__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__util_generate_id__ = __webpack_require__(128);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__util_throw_error__ = __webpack_require__(36);
...
var _setDisplayName = __webpack_require__(49);
...
var routes = {
    ...
    '/cheese': {
        text: "Fondue blue castello when the cheese comes out everybody's happy.       Pecorino cheddar edam roquefort bocconcini paneer cheesecake halloumi.       Camembert de normandie danish fontina bocconcini say cheese fromage swiss       halloumi cottage cheese. Macaroni cheese cauliflower cheese.\n\n      Cheese strings smelly cheese cauliflower cheese. Smelly cheese cheesecake       brie cut the cheese halloumi st. agur blue cheese the big cheese halloumi.       Monterey jack cheese and wine cheese slices babybel roquefort gouda       port-salut cheesy grin. Cauliflower cheese boursin.\n\n      Cheesy feet when the cheese comes out everybody's happy monterey jack.       Bocconcini taleggio taleggio bavarian bergkase gouda cheesy grin everyone       loves pecorino. Camembert de normandie camembert de normandie gouda fromage       frais manchego bocconcini ricotta cut the cheese. Cheesy feet cheese on toast.\n\n      The big cheese who moved my cheese cheesecake. Lancashire brie swiss port-salut       danish fontina cheesy feet pecorino edam. Brie paneer rubber cheese roquefort       danish fontina cut the cheese swiss caerphilly. Fromage frais cheese triangles       say cheese caerphilly danish fontina boursin cheese strings halloumi.       Cheese triangles.",
        images: [
    ...
    '/dog': {
        text: "Boerboel brussels griffon cardigan welsh corgi czechoslovakian vlcak dandie       dinmont terrier german pinscher german shepherd dog glen of imaal terrier great       pyrenees lowchen neapolitan mastiff samoyed st. bernard staffordshire bull terrier       tosa treeing walker coonhound weimaraner whippet. Affenpinscher alaskan malamute       azawakh bearded collie bergamasco bracco italiano chihuahua deutscher wachtelhund       english toy spaniel french bulldog irish wolfhound kooikerhondje maltese miniature       bull terrier plott russian toy saluki slovensky cuvac swedish vallhund tibetan       mastiff tibetan spaniel toy fox terrier welsh springer spaniel. Beauceron bull       terrier cairn terrier finnish spitz french bulldog harrier norrbottenspets       otterhound portuguese water dog rhodesian ridgeback soft coated wheaten terrier       treeing tennessee brindle.\n\n      Belgian malinois boerboel dutch shepherd english setter havanese irish wolfhound       jindo kromfohrlander pekingese portuguese water dog rottweiler saluki smooth fox       terrier spanish mastiff spinone italiano. Barbet briard cocker spaniel dogue de       bordeaux french spaniel german pinscher hamiltonstovare norwegian buhund nova       scotia duck tolling retriever pomeranian smooth fox terrier spanish mastiff spanish       water dog standard schnauzer weimaraner yorkshire terrier. Brussels griffon flat-coated       retriever german pinscher icelandic sheepdog karelian bear dog keeshond miniature       american shepherd miniature schnauzer welsh terrier yorkshire terrier. Akita american       foxhound azawakh barbet beagle boerboel bull terrier clumber spaniel curly-coated       retriever drentsche patrijshond english toy spaniel german wirehaired pointer glen of       imaal terrier harrier havanese lagotto romagnolo lowchen mastiff newfoundland       norrbottenspets norwegian buhund pointer portuguese podengo pequeno portuguese water dog       shetland sheepdog siberian husky sloughi swedish vallhund tibetan mastiff.",
        images: [
    ...
    '/cat': {
        text: "Lick sellotape use lap as chair destroy couch sun bathe, slap owner's face at 5am       until human fills food dish who's the baby. Ears back wide eyed stand in front of       the computer screen chase imaginary bugs. Pee in the shoe walk on car leaving trail       of paw prints on hood and windshield for walk on car leaving trail of paw prints on       hood and windshield and steal the warm chair right after you get up and eat a plant,       kill a hand. Chase imaginary bugs get video posted to internet for chasing red dot       for meowwww. Lick butt.\n\n      The dog smells bad hide at bottom of staircase to trip human. Howl uncontrollably       for no reason purr while eating yet eat a plant, kill a hand so use lap as chair       leave dead animals as gifts meowing non stop for food. Ignore the squirrels,       you'll never catch them anyway step on your keyboard while you're gaming and then       turn in a circle soft kitty warm kitty little ball of furr scream at teh bath stare       at ceiling mark territory. Gnaw the corn cob i am the best step on your keyboard while       you're gaming and then turn in a circle unwrap toilet paper. Bathe private parts with       tongue then lick owner's face meow so meow for food, then when human fills food dish,       take a few bites of food and continue meowing find empty spot in cupboard and sleep       all day.",
        images: [
    ...
    '/hipster': {
        text: "Franzen gluten-free fixie, stumptown drinking vinegar chia lo-fi tumblr cornhole       you probably haven't heard of them disrupt. Keytar chartreuse locavore, listicle       kinfolk celiac distillery bespoke. Tilde thundercats next level actually, flannel       kale chips raw denim art party pug. Next level paleo VHS, williamsburg venmo swag       scenester messenger bag. Hammock cardigan microdosing tofu messenger bag. Fingerstache       kale chips marfa plaid post-ironic. 8-bit chia distillery leggings keffiyeh.\n\n      Cliche cred flannel waistcoat, polaroid banjo forage salvia tilde iPhone sriracha       chillwave slow-carb crucifix. Sriracha bushwick readymade hammock. Portland humblebrag       cornhole 90's, bespoke lo-fi ennui PBR&B semiotics crucifix actually. Green juice       PBR&B polaroid, messenger bag gastropub 8-bit brunch lomo celiac listicle. Put a bird       on it portland PBR&B deep v, tattooed brooklyn literally. Cornhole wayfarers 3 wolf moon,       neutra pug VHS four loko banjo iPhone typewriter man braid truffaut YOLO tacos heirloom.       Actually 3 wolf moon cray microdosing gastropub tattooed, trust fund franzen leggings       literally.",
        images: [
...
exports.default = function (store) { return function (Root) { return (React.createElement(react_redux_1.Provider, { store: store },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mapStateToProps__ = __webpack_require__(142);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mergeProps__ = __webpack_require__(143);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__selectorFactory__ = __webpack_require__(144);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
/* unused harmony export pureFinalPropsSelectorFactory */
/* harmony export (immutable) */ __webpack_exports__["a"] = finalPropsSelectorFactory;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__verifySubselectors__ = __webpack_require__(145);
function _objectWithoutProperties(obj, keys) { var target = {}; for (var i in obj) { if (keys.indexOf(i) >= 0) continue; if (!Object.prototype.hasOwnProperty.call(obj, i)) continue; target[i] = obj[i]; } return target; }
...
var COLUMN_COUNT = 2;
var columnize = function (array, columns) {
    var remainder = array.length % columns;
    var chunkSize = Math.floor(array.length / columns);
    var firstChunkSize = chunkSize + remainder;
    var firstChunk = array.slice(0, firstChunkSize);
    return [firstChunk].concat(lodash_1.chunk(array.slice(firstChunkSize, array.length), chunkSize));
};
;
var Gallery = function (_a) {
    var images = _a.images, columns = _a.columns, rest = __rest(_a, ["images", "columns"]);
    return (React.createElement("div", __assign({ style: styles.gallery }, rest), columnize(images, columns).map(function (column, index) {
        return React.createElement("div", { key: index, style: styles.column }, column.map(function (image, imageIndex) {
            return React.createElement("img", { key: imageIndex, style: styles.image, src: image });
        }));
    })));
};
...
var Demo = function (_a) {
    ...
    var demoRoutes = ['/cheese', '/cat', '/dog', '/hipster'];
    return (React.createElement("div", { style: styles.container },
        React.createElement(redux_little_router_1.Fragment, { forRoute: "/", style: styles.container },
            React.createElement("div", null,
                React.createElement("h1", { style: styles.tagline },
                    React.createElement("span", { style: styles.secondary }, "A Compendium of"),
                    React.createElement("br", null),
                    React.createElement("span", { style: styles.primary }, "Ipsums and GIFs")),
                React.createElement("div", { style: styles.nav },
                    React.createElement(redux_little_router_1.Link, { href: { pathname: '/cheese', query: { is: 'cheese' } } }, "Cheese"),
                    React.createElement(redux_little_router_1.Link, { href: "/dog", style: { color: 'red' } }, "Dog"),
                    React.createElement(redux_little_router_1.Link, { href: "/cat?is=cat" }, "Cat"),
                    React.createElement(redux_little_router_1.Link, { href: "/hipster" }, "Hipster"),
                    React.createElement(redux_little_router_1.Link, { href: "/nonexistent", activeProps: {
                            style: {
                                backgroundColor: '#e32636'
                            }
                        } }, "My Design Skills")),
                React.createElement("div", null, demoRoutes.map(function (route) {
                    return React.createElement(redux_little_router_1.Fragment, { key: route, forRoute: route },
                        React.createElement("div", null,
                            React.createElement("p", null, location.result && location.result.text),
                            React.createElement(Gallery, { images: location.result && location.result.images, columns: COLUMN_COUNT })));
                })),
                React.createElement(redux_little_router_1.Fragment, { forRoute: "/" },
                    React.createElement("p", null, "Pickum ipsum!")),
                React.createElement(redux_little_router_1.Fragment, { forNoMatch: true },
                    React.createElement("div", null,
                        React.createElement("h2", null, "FOUR O'FOUR"),
                        React.createElement("p", null, "Looks like you found something that doesn't exist!"),
                        React.createElement("img", { style: styles.noMatchImage, src: "http://i1.kym-cdn.com/photos/images/original/001/018/866/e44.png" })))))));
};
...
exports.default = react_redux_1.connect(mapStateToProps)(Demo);
